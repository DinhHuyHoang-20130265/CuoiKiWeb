                ...
                <div class="padding-container">
                    <div class="row">
                            ...
                            <div class="omni-layout-card card-default">
                                ...
                                <div class="omni-layout-card--section">
                                    <div class="text-right">
                                        <button class="btn btn-primary"><span>Giao
                                                    hàng</span></button>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="mb15 text-right">
                                                <button class="btn btn-default"><span>Cập
                                                            nhật</span></button>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="timeline-emojipicker border-top-0 p-0">
                                        <div class="emoji-container">
                                            ...
                                            <div class="emoji-action">
                                                ...
                                                <div class="emoji-action__button">
                                            ...
                                            <div class="timeline-event-content ">
                                                <div class="timeline-item">
                                                    <div class="timeline-body">
                                                        ...
                                                        <time class="timeline__time"><span>07:52
                                                                    SA</span></time>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="timeline-event-content ">
                                                <div class="timeline-item">
                                                    <div class="timeline-body">
                                                        <div class="timeline__message-container">
                                                            <div
                                                                    class="timeline__wrapper__inner-message table-updown-historylog timeline-inner--message--textcolor"
                                                        ...
                                                        <time class="timeline__time"><span>07:51
                                                                    SA</span></time>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="col-lg-3 col-12">
                            <div class="omni-layout-card card-default">
                                ...
                                <div class="omni-layout-card--section">
                                    <div class="mb16">Vui lòng xác thực đơn hàng</div>
                                    <button
                            ...
                            <div class="omni-layout-card card-default">
                                ...
                                <div class="omni-layout-card--section"><a class="d-block" target="_blank"
                                                                          href="/admin/customers/1019145491">nguyen
                                    hien</a>
                    ...
                    <div class="order-delete--block">
                        <div class="row">
                            <div class="col-lg-9 col-12">
                                <div class="">
                                    <button class="btn btn-danger mr-0"><span>Xóa đơn hàng</span>
                                        <div class="display-none"></div>
                                    </button>
                                </div>
                            </div>
