                                    ...
                                    <ul class="sidebar-nav">
                                        ...
                                        <li>
                                            ...
                                            <ul class="sidebar-nav">
                                                ...
                                                <li>
                                                    <a href="./post-editor.html"> Chỉnh sửa bài báo</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                ...
                                <div class="col-sm-10">
                                    <div class="images-container">
                                        <div class="image-container">
                                            ...
                                            <div class="image" style="background-image:url('https://s3.amazonaws.com/uifaces/faces/twitter/brad_frost/128.jpg')" >Ảnh chính</div>
                                        </div>
                                        <div class="image-container">
                                            <div class="controls">
                                                <a href="" class="control-btn move">
