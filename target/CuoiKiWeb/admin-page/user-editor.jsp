                                ...
                                <ul class="sidebar-nav">
                                    ...
                                    <li>
                                        ...
                                        <ul class="sidebar-nav">
                                            ...
                                            <li>
                                                <a href="./user-editor.html"> Chỉnh sửa thông tin người dùng</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                ...
                <form name="item">
                    <div class="card card-block">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" style="width:200px" class="form-control boxed" placeholder="Nhập username">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 form-control-label text-xs-right"> Password: </label>
                            <div class="col-sm-10">
                                <input type="password" style="width:200px" class="form-control boxed" placeholder="Nhập password">
                            </div>
                        </div>
                        <div class="form-group row">
