      ...
      <div class="row">
        <div class="col-sm-12 col-lg-6">
          <form action="" method="POST" class="form" id="form-1">
            ...
            <button class="form-submit btn-blocker" style="border-radius: unset;">Gửi <i class="fas fa-arrow-right" style="font-size: 16px;margin-left: 10px;"></i></button>
            <p style="font-size: 16px;margin: 10px 0;">Quay trở lại <a href="Login.jsp" style="color: black; font-weight: bold">Đăng nhập</a></p>
          </form>
        </div>
        <div class="col-sm-12 col-lg-6">
